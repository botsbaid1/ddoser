...
\033[0;36m                              
\033[0;36m =============hackbaid CREATED THIS DDOS======================"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] HD-STORE | Api Connected [5] | Backup Server [1] | Online User [2] | Admin: [hackbaid] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		sin = input("\033[0;36m{}\033[0;34m@[DDOSER]\033[36m--> \033[0;31m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("cls")
			print (banner)
